...
@router.post("/execute/managed", response_model=PromptExecuteResponse, tags=["Execution"])
...
@router.post("/users/{user_id}/keys", status_code=status.HTTP_204_NO_CONTENT, tags=["User Management"])
